...
def main():
	...
	audio1_path = opt.video1_name.replace('/top_detections_new/','/reshape_11025_new/')
	...
	for i in range(opt.num_of_object_detections_to_use):
		...
		frame1_PATH = opt.video1_name.replace('/top_detections_new/','/frame_new/')
		frame1_PATH = frame1_PATH.replace('/top_detections/','/frame/')
		frame2_PATH = opt.video2_name.replace('/top_detections_new/','/frame_new/')
