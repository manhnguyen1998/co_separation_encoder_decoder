...
import os
list_file = []
with open('test_solo_mul_2v1.txt') as f:
    lines = f.readlines()
    for line in lines:
        line = line.split(" ")
        video_name1 = line[0]
        ...
        cmd = ["python", "test.py", "--video1_name", video_name1,"--video2_name", video_name2,"--visual_pool", "conv1x1","--unet_num_layers", "7","--data_path", "/ext_data2/manhnh/MUSIC_dataset","--weights_visual", "/home/manhnguyen/new/co-separation/dataset/res101/open_images_v4/visual_latest.pth","--weights_unet", "/home/manhnguyen/new/co-separation/dataset/res101/open_images_v4/unet_latest.pth","--weights_classifier", "/home/manhnguyen/new/co-separation/dataset/res101/open_images_v4/classifier_latest.pth","--num_of_object_detections_to_use", "5","--scene_path", "/home/manhnguyen/new/co-separation/iccv2019_co_separation/iccv2019_co_separation/ADE.h5","--output_dir_root", "resultsD3_on_pretrain/mul_2v1"]
        subprocess.run(cmd)
